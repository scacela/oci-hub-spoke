...
#     "hub private compute display names: ${join(", ", oci_core_instance.hub_priv_compute.*.display_name})}",
...
#     "spoke private compute display names: ${join(", ", oci_core_instance.spoke_priv_compute.*.display_name})}",
